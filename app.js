...
System.register("npm:react-dom@0.14.0-beta3/index", ["npm:react@0.14.0-beta3/lib/ReactDOM"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = require("npm:react@0.14.0-beta3/lib/ReactDOM");
  global.define = __define;
  return module.exports;
});
...
System.register("npm:react-dom@0.14.0-beta3", ["npm:react-dom@0.14.0-beta3/index"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = require("npm:react-dom@0.14.0-beta3/index");
  global.define = __define;
  return module.exports;
});
...
System.register('app/repo', ['npm:babel-runtime@5.8.20/helpers/get', 'npm:babel-runtime@5.8.20/helpers/inherits', 'npm:babel-runtime@5.8.20/helpers/create-class', 'npm:babel-runtime@5.8.20/helpers/class-call-check', 'npm:react@0.14.0-beta3'], function (_export) {
...
System.register('app/repository-list', ['npm:babel-runtime@5.8.20/helpers/get', 'npm:babel-runtime@5.8.20/helpers/inherits', 'npm:babel-runtime@5.8.20/helpers/create-class', 'npm:babel-runtime@5.8.20/helpers/class-call-check', 'npm:react@0.14.0-beta3', 'app/repo', 'app/api'], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, React, Repo, reposForUser, RespositoryList;
  ...
  return {
    ...
    execute: function () {
      ...
      RespositoryList = (function (_React$Component) {
        _inherits(RespositoryList, _React$Component);

        function RespositoryList(props) {
          _classCallCheck(this, RespositoryList);

          _get(Object.getPrototypeOf(RespositoryList.prototype), 'constructor', this).call(this, props);
          this.state = {
            repos: []
          };
        }

        _createClass(RespositoryList, [{
    ...
    execute: function () {
      ...
      HelloWorld = (function (_React$Component) {
        ...
        _createClass(HelloWorld, [{
          key: 'render',
          value: function render() {
            return React.createElement("div", null, React.createElement("h2", null, "open sauce"), React.createElement(RepositoryList, null));
          }
        }]);
      ...
      _export('default', HelloWorld);
    }
  };
});
System.register('app/main', ['npm:whatwg-fetch@0.9.0', 'npm:react@0.14.0-beta3', 'npm:react-dom@0.14.0-beta3', 'app/HelloWorld.jsx!github:floatdrop/plugin-jsx@1.1.0'], function (_export) {
  'use strict';

  var fetch, React, ReactDOM, HelloWorld;
  return {
    setters: [function (_npmWhatwgFetch090) {
      fetch = _npmWhatwgFetch090['default'];
    }, function (_npmReact0140Beta3) {
      React = _npmReact0140Beta3['default'];
    }, function (_npmReactDom0140Beta3) {
      ReactDOM = _npmReactDom0140Beta3['default'];
    }, function (_appHelloWorldJsxGithubFloatdropPluginJsx110) {
      HelloWorld = _appHelloWorldJsxGithubFloatdropPluginJsx110['default'];
    }],
    execute: function () {

      (function () {
        ReactDOM.render(React.createElement(HelloWorld, null), document.getElementById('react-app'));
      })();
    }
  };
});
